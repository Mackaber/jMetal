...
import me.mackaber.tesis.Util.LocalSearchCallback;
...
public class CustomLocalSearch<S extends Solution<?>> implements LocalSearchOperator<S>{
    private LocalSearchCallback callback;
     ...
     */
    public CustomLocalSearch(int improvementRounds, MutationOperator<S> mutationOperator,
    ...
    public CustomLocalSearch(int improvementRounds, MutationOperator<S> mutationOperator,
                             Comparator<S> comparator, Problem<S> problem, LocalSearchCallback callback){
        this(improvementRounds,mutationOperator, comparator, problem, () -> JMetalRandom.getInstance().nextDouble());
    ...
    public S execute(S solution) {
        ...
        while (i < rounds) {
            ...
            i++ ;
            callback.execute(solution.getObjective(0));
        }
