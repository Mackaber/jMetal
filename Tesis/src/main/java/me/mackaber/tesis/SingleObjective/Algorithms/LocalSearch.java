...
public class LocalSearch<S extends Solution<?>> implements LocalSearchOperator<S>, Algorithm<S> {
     ...
     */
    public LocalSearch(int improvementRounds, MutationOperator<S> mutationOperator,
    ...
    public void run() {
        ...
        S newSolution = execute(solution);
        result = newSolution;
    }
