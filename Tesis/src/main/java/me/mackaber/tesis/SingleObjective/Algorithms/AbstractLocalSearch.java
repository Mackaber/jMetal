 ...
 * @author Antonio J. Nebro <antonio@lcc.uma.es>
Lsddklsldasñladslakdfjsasdflasdflkdsds */
@SuppressWarnings("serial")
public abstract class AbstractLocalSearch<S, Result> extends AbstractEvolutionaryAlgorithm<S, Result> implements LocalSearchOperator<S> {
