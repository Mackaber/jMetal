...
public class CombinationNPointCrossoverWithoutRepair implements CrossoverOperator<GroupSolution> {
    private final JMetalRandom randomNumberGenerator = JMetalRandom.getInstance();
    private final double probability;
    private final int crossovers;

    public CombinationNPointCrossoverWithoutRepair(double probability, int crossovers) {
    ...
    public CombinationNPointCrossoverWithoutRepair(int crossovers) {
        this.crossovers = crossovers;
